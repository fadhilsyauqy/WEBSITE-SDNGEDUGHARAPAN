...
//konfigurasi
$jmlhperhalaman = 12;
$jmlhData = count(query("SELECT * FROM guru"));
$jmlhHal = ceil($jmlhData / $jmlhperhalaman);
$halAktif = (isset($_GET["page"])) ? $_GET["page"] : 1;
$awalHal = ($jmlhperhalaman * $halAktif) - $jmlhperhalaman;

$guru = query("SELECT * FROM guru LIMIT $awalHal, $jmlhperhalaman");
    ...
    <div class="container mt-3 min-vh-100">
        ...
        <?php if (!isset($_POST["cari"])) : ?>
            <ul class="pagination justify-content-center m-5">
                <?php if ($halAktif > 1) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?page=<?= $halAktif - 1; ?>" aria-label="Previous">
                ...
                <?php for ($i = 1; $i <= $jmlhHal; $i++) : ?>
                    <li class="page-item <?php if ($i == $halAktif) echo 'active'; ?>">
                        <a class="page-link" href="?page=<?= $i; ?>" style="<?php if ($i == $halAktif) echo 'background-color: #14274E; color: white;'; ?>">
                            <?= $i; ?>
                        </a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if ($halAktif < $jmlhHal) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?page=<?= $halAktif + 1; ?>" aria-label="Next">
